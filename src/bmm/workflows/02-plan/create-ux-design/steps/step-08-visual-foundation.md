...
- Read fully and follow: {project-root}/_.mdan/core/workflows/advanced-elicitation/workflow.xml with the current visual foundation content
...
- Read fully and follow: {project-root}/_.mdan/core/workflows/party-mode/workflow.md with the current visual foundation
...
- Load `{project-root}/_.mdan/mdan/workflows/2-plan-workflows/create-ux-design/steps/step-09-design-directions.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_.mdan/mdan/workflows/2-plan-workflows/create-ux-design/steps/step-09-design-directions.md` to generate design direction mockups.
