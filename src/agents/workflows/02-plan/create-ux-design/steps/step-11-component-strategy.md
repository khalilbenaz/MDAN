...
- Read fully and follow: {project-root}/_.mdan/core/workflows/advanced-elicitation/workflow.xml with the current component strategy content
...
- Read fully and follow: {project-root}/_.mdan/core/workflows/party-mode/workflow.md with the current component strategy
