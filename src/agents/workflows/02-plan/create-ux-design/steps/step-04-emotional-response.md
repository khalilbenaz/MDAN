...
- Read fully and follow: {project-root}/_.mdan/core/workflows/advanced-elicitation/workflow.xml with the current emotional response content
...
- Read fully and follow: {project-root}/_.mdan/core/workflows/party-mode/workflow.md with the current emotional response definition
...
- Load `{project-root}/_.mdan/mdan/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_.mdan/mdan/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md` to analyze UX patterns from inspiring products.
