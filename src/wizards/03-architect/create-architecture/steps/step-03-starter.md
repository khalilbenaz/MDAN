...
- Read fully and follow: {project-root}/_.mdan/core/workflows/advanced-elicitation/workflow.xml with current starter analysis
...
- Read fully and follow: {project-root}/_.mdan/core/workflows/party-mode/workflow.md with starter evaluation context
