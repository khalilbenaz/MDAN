...
- Read fully and follow: {project-root}/_mdan/core/workflows/advanced-elicitation/workflow.xml with current starter analysis
...
- Read fully and follow: {project-root}/_mdan/core/workflows/party-mode/workflow.md with starter evaluation context
...
- Load `{project-root}/_mdan/mdan/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md` to begin making specific architectural decisions.
