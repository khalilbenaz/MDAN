...
- **NEXT:** Read fully and follow: `{project-root}/_mdan/mdan/workflows/mdan-quick-flow/quick-dev/steps/step-03-execute.md`
...
- IF E: Ask for any additional guidance, then **NEXT:** Read fully and follow: `{project-root}/_mdan/mdan/workflows/mdan-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
**[W] Seems bigger than quick-dev** - Recommend the Full MDAN Flow PRD Process
**[E] Execute directly**
...
- IF E: Ask for guidance, then **NEXT:** Read fully and follow: `{project-root}/_mdan/mdan/workflows/mdan-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
**[W] Start MDAN Method** (recommended)
...
- Mode A (tech-spec): "**NEXT:** read fully and follow: `{project-root}/_mdan/mdan/workflows/mdan-quick-flow/quick-dev/steps/step-03-execute.md`"
- Mode B (direct, [E] selected): "**NEXT:** Read fully and follow: `{project-root}/_mdan/mdan/workflows/mdan-quick-flow/quick-dev/steps/step-02-context-gathering.md`"
