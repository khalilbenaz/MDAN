...
- Load `{project-root}/_.mdan/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_.mdan/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md` to analyze UX patterns from inspiring products.
