...
- Read fully and follow: {project-root}/_mdan/core/workflows/advanced-elicitation/workflow.xml with the current design system content
...
- Read fully and follow: {project-root}/_mdan/core/workflows/party-mode/workflow.md with the current design system choice
...
- Load `{project-root}/_mdan/mdan/workflows/2-plan-workflows/create-ux-design/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/2-plan-workflows/create-ux-design/steps/step-07-defining-experience.md` to define the core user interaction.
