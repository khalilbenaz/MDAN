...
- Load: `{project-root}/_mdan/mdan/workflows/1-analysis/research/market-steps/step-02-customer-behavior.md`
...
After user confirmation and scope finalization, load `{project-root}/_mdan/mdan/workflows/1-analysis/research/market-steps/step-02-customer-behavior.md` to begin detailed market research with customer insights analysis.
