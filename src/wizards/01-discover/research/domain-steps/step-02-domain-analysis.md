...
- Load: `{project-root}/_mdan/mdan/workflows/1-analysis/research/domain-steps/step-03-competitive-landscape.md`
...
After user selects 'C', load `{project-root}/_mdan/mdan/workflows/1-analysis/research/domain-steps/step-03-competitive-landscape.md` to analyze competitive landscape, key players, and ecosystem analysis for {{research_topic}}.
