...
const commands = {
  ...
  check: { load: () => import('./commands/check.js'), summary: 'Quality gate on planning artifacts (exit 1 on FAIL)' },
  trace: { load: () => import('./commands/trace.js'), summary: 'Requirement → story → test traceability matrix' },
  scope: { load: () => import('./commands/scope.js'), summary: 'How much process a change needs (oneshot / spec / full)' },
  bundle: { load: () => import('./commands/bundle.js'), summary: 'Web bundles for ChatGPT GPTs, Gemini Gems, Claude Projects' },
  export: { load: () => import('./commands/export.js'), summary: 'Export epics/stories to CSV, GitHub, Azure DevOps or Jira' },
