 ...
 * - mdan/workflows/plan-project.md → mdan-mdan-plan-project.md
 * - mdan/tasks/create-story.md → mdan-mdan-create-story.md
 ...
 * Converts: 'mdan', 'agents', 'pm' → 'mdan-agent-mdan-pm.md'
 * Converts: 'mdan', 'workflows', 'correct-course' → 'mdan-mdan-correct-course.md'
 * Converts: 'core', 'agents', 'brainstorming' → 'mdan-agent-brainstorming.md' (core agents skip module name)
 *
 * @param {string} module - Module name (e.g., 'mdan', 'core')
 * @param {string} type - Artifact type ('agents', 'workflows', 'tasks', 'tools')
 * @param {string} name - Artifact name (e.g., 'pm', 'brainstorming')
 * @returns {string} Flat filename like 'mdan-agent-mdan-pm.md' or 'mdan-mdan-correct-course.md'
 */
function toDashName(module, type, name) {
  const isAgent = type === AGENT_SEGMENT;

  // For core and mdan modules, skip the module name: use 'mdan-agent-name.md' instead of 'mdan-agent-core-name.md'
  if (module === 'core' || module === 'mdan' || module === 'mdan') {
 ...
 * Converts: 'mdan/agents/pm.md' → 'mdan-agent-mdan-pm.md'
 * Converts: 'mdan/agents/tech-writer/tech-writer.md' → 'mdan-agent-mdan-tech-writer.md' (uses folder name)
 * Converts: 'mdan/workflows/correct-course.md' → 'mdan-mdan-correct-course.md'
 * Converts: 'core/agents/brainstorming.md' → 'mdan-agent-brainstorming.md' (core agents skip module name)
 *
 * @param {string} relativePath - Path like 'mdan/agents/pm.md'
 * @returns {string} Flat filename like 'mdan-agent-mdan-pm.md' or 'mdan-brainstorming.md'
 */
function toDashPath(relativePath) {
  ...
  // e.g., 'mdan/agents/tech-writer/tech-writer' → 'tech-writer' (not 'tech-writer-tech-writer')
 ...
 * Parses: 'mdan-agent-mdan-pm.md' → { prefix: 'mdan', module: 'mdan', type: 'agents', name: 'pm' }
 * Parses: 'mdan-mdan-correct-course.md' → { prefix: 'mdan', module: 'mdan', type: 'workflows', name: 'correct-course' }
