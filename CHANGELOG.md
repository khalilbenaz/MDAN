...
MDAN vs BMAD-METHOD v6: see `docs/explanation/mdan-vs-bmad.md`.
...
- Documentation: English README (`README.en.md`, generated sections included), docs reorganised by purpose (tutorial, how-to guides, CLI/MCP/modules/config reference, concepts) and an honest MDAN vs BMAD comparison.
