#!/bin/bash
# Rewrite the install script to download the files directly instead of trying to copy them from local when curled.
cat << 'INSTALL' > /Users/lilou/Downloads/MDANV2/install.sh
#!/bin/bash
