 ...
 *
 * Transforms:
 *   /img/foo.png → /MDAN/img/foo.png (when base is /MDAN/)
 *   /llms.txt → /MDAN/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/MDAN/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /MDAN/img/foo.png.
