 ...
 *
 * Transforms:
 *   /img/foo.png → /MDAN-METHOD/img/foo.png (when base is /MDAN-METHOD/)
 *   /llms.txt → /MDAN-METHOD/llms.txt
 *
 * Supported elements:
 ...
 * @param {string} options.base - The base path to prepend (e.g., '/MDAN-METHOD/')
...
export default function rehypeBasePaths(options = {}) {
  ...
  // produces correct paths like /MDAN-METHOD/img/foo.png.
