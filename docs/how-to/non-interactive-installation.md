...
description: Install MDAN using command-line flags for CI/CD pipelines and automated deployments
sidebar:
  order: 2
---

Use command-line flags to install MDAN non-interactively. This is useful for:
...
| `--modules <modules>` | Comma-separated module IDs | `--modules mdan,bmb` |
...
| `--output-folder <path>` | Output folder path | _mdan-output |
...
MDAN validates all provided flags:
