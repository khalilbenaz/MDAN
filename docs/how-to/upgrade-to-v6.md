...
description: Migrate from MDAN v4 to v6
sidebar:
  order: 3
---

Use the MDAN installer to upgrade from v4 to v6, which includes automatic detection of legacy installations and migration assistance.
...
Follow the [Installer Instructions](./install-mdan.md).
...
Manually remove legacy v4 IDE commands - for example if you have claude, look for any nested folders that start with mdan and remove them:

- `.claude/commands/MDAN/agents`
- `.claude/commands/MDAN/tasks`

### 4. Migrate Planning Artifacts

**If you have planning documents (Brief/PRD/UX/Architecture):**

Move them to `_mdan-output/planning-artifacts/` with descriptive names:
...
2. Place `epics.md` or `epics/epic*.md` in `_mdan-output/planning-artifacts/`
...
│   ├── bmm/             # MDAN Method module
│   ├── bmb/             # MDAN Builder
│   └── cis/             # Creative Intelligence Suite
└── _mdan-output/        # Output folder (was doc folder in v4)
```
...
| v4 Module                     | v6 Status                                 |
| ----------------------------- | ----------------------------------------- |
| `.mdan-2d-phaser-game-dev`    | Integrated into BMGD Module               |
| `.mdan-2d-unity-game-dev`     | Integrated into BMGD Module               |
| `.mdan-godot-game-dev`        | Integrated into BMGD Module               |
| `.mdan-infrastructure-devops` | Deprecated — new DevOps agent coming soon |
| `.mdan-creative-writing`      | Not adapted — new v6 module coming soon   |
