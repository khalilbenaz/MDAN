---
title: Roadmap
description: What's next for MDAN - Features, improvements, and community contributions
---

# The MDAN Method: Public Roadmap

The MDAN Method, MDAN Method Module (MDAN), and MDAN Builder (BMB) are evolving. Here's what we're working on and what's coming next.
...
<div class="roadmap-container">
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      ...
      <p>Entertainment, security, therapy, roleplay and much more. Expand the MDAN Method platform.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">⚡</span>
  ...
  <div class="roadmap-future">
    ...
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🖥️</span>
      <h4>Official UI</h4>
      <p>A beautiful interface for the entire MDAN ecosystem. CLI power, GUI polish.</p>
    </div>
    <div class="roadmap-future-card">
      <span class="roadmap-emoji">🔒</span>
      <h4>MDAN in a Box</h4>
  ...
  <div style="text-align: center; margin-top: 3rem; padding: 2rem; background: var(--color-bg-card); border-radius: 12px; border: 1px solid var(--color-border);">
    ...
    <p style="color: var(--slate-color-400); margin: 1rem 0 0;">
      ...
      <a href="mailto:contact@mdancode.com" style="color: var(--color-in-progress);">contact@mdancode.com</a>
    </p>
  </div>
</div>
