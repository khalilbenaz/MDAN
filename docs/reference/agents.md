---
title: Agents
description: Default MDAN agents with their menu triggers and primary workflows
sidebar:
  order: 2
---
...
This page lists the default MDAN (Agile suite) agents that install with MDAN Method, along with their menu triggers and primary workflows.
...
- QA (Quinn) is the lightweight test automation agent in MDAN. The full Test Architect (TEA) lives in its own module.
