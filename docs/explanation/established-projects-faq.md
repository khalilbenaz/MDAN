...
description: Common questions about using MDAN Method on established projects
sidebar:
  order: 8
---
Quick answers to common questions about working on established projects with the MDAN Method (MDAN).
...
MDAN respects your choice — it won't force modernization, but it will offer it.

**Have a question not answered here?** Please [open an issue](https://github.com/mdan-code-org/MDAN-METHOD/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
