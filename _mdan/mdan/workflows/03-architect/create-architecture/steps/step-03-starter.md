...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current starter analysis
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with starter evaluation context
...
- Load `{project-root}/_mdan/mdan/workflows/03-architect/create-architecture/steps/step-04-decisions.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/03-architect/create-architecture/steps/step-04-decisions.md` to begin making specific architectural decisions.
