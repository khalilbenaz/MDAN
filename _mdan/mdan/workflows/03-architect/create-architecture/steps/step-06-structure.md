...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current project structure
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with project structure context
...
- Load `{project-root}/_mdan/mdan/workflows/03-architect/create-architecture/steps/step-07-validation.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/03-architect/create-architecture/steps/step-07-validation.md` to validate architectural coherence and completeness.
