...
- **Append the final session content to `mdan_output/brainstorming/brainstorming-session-{{date}}.md`**
...
When user selects 'C', append the content directly to `mdan_output/brainstorming/brainstorming-session-{{date}}.md` using the structure from step 7.
