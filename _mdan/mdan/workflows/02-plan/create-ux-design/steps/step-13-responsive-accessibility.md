...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current responsive/accessibility content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current responsive/accessibility strategy
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-14-complete.md` to finalize the UX design workflow.
