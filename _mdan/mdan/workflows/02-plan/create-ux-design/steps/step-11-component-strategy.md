...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current component strategy content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current component strategy
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-12-ux-patterns.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-12-ux-patterns.md` to define UX consistency patterns.
