...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current design system content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current design system choice
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-07-defining-experience.md` to define the core user interaction.
