...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current user journey content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current user journeys
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-11-component-strategy.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-11-component-strategy.md` to define component library strategy.
