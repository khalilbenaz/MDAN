...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current inspiration analysis content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current inspiration analysis
...
- Read fully and follow: `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-06-design-system.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-06-design-system.md` to choose the appropriate design system approach.
