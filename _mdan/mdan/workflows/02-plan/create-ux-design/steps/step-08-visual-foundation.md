...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current visual foundation content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current visual foundation
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-09-design-directions.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-09-design-directions.md` to generate design direction mockups.
