...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current core experience content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current core experience definition
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-04-emotional-response.md` to define desired emotional responses.
