...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current design direction content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current design direction
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-10-user-journeys.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-10-user-journeys.md` to design user journey flows.
