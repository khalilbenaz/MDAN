...
- Run an advanced elicitation pass: ask deep, probing questions to sharpen the current UX patterns content
...
- Read fully and follow: {project-root}/_mdan/mdan/workflows/special/party-mode/wizard.md with the current UX patterns
...
- Load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-13-responsive-accessibility.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-ux-design/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.
