...
# File References
nextStepFile: '{project-root}/_mdan/mdan/workflows/02-plan/create-prd/steps/step-05-domain.md'
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-prd/steps/step-05-domain.md`.
