...
# File References
nextStepFile: '{project-root}/_mdan/mdan/workflows/02-plan/create-prd/steps/step-04-journeys.md'
...
After user selects 'C' and content is saved to document, load `{project-root}/_mdan/mdan/workflows/02-plan/create-prd/steps/step-04-journeys.md` to map user journeys.
