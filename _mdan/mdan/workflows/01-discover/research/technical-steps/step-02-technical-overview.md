...
- Load: `{project-root}/_mdan/mdan/workflows/01-discover/research/technical-steps/step-03-integration-patterns.md`
...
After user selects 'C', load `{project-root}/_mdan/mdan/workflows/01-discover/research/technical-steps/step-03-integration-patterns.md` to analyze APIs, communication protocols, and system interoperability for {{research_topic}}.
